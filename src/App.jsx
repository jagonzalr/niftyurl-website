  ...
  return (
    <Fragment>
      <div className='container mx-auto p-8'>
        <section className='mt-32 mb-6 inline-flex items-center'>
          <svg
          ...
          <h1 className='font-bold text-6xl ml-4'>Nifty URL</h1>
        </section>
        <section className='text-3xl'>
          <p>Remember which URLs are useful when revisiting them.</p>
        </section>
      </div>
    </Fragment>
  )
